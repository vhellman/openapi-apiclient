...
function convertToZodSchema(property: any): z.ZodTypeAny {
    ...
    case 'object':
      return z.object(
        Object.entries(property.properties || {}).reduce(
          (acc, [key, value]) => ({
            ...acc,
            [key]: convertToZodSchema(value as any),
          }),
          {}
        )
      );
...
function generateZodSchemas(components: any): string {
...
export function generateSchemasFile(spec: any, outputDir: string): void {
